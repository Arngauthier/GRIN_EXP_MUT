...
void grin_assert_fail(const char *AssertionBody,
                       const char *Message,
                       const char *File,
                       unsigned Line) {
...
void grin_check_fail(const char *CheckBody,
                      const char *Message,
                      const char *File,
                      unsigned Line) {
...
void grin_do_abort(const char *Message, const char *File, unsigned Line) {
