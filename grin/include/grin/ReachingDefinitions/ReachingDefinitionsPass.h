...
#include "grin/StackAnalysis/StackAnalysis.h"
...
public:
  ...
  virtual void releaseMemory() override {
    grin_log(ReleaseLog, "ReachingDefinitionsPass is releasing memory");
...
public:
  ...
  virtual void releaseMemory() override {
    grin_log(ReleaseLog, "ConditionNumberingPass is releasing memory");
...
public:
  ...
  virtual void releaseMemory() override {
    grin_log(ReleaseLog, "ConditionalReachedLoadsPass is releasing memory");
